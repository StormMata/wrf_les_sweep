...
remove_data = 00.0 # in minutes;  discard first xxx minutes (e.g., ~2 flow-through times)

file2read = netCDF4.Dataset('/anvil/scratch/x-smata/wrf_les_sweep/runs/gad_sweep/s0_v0/wrfout_d02_0001-01-01_00_30_00','r',mmap=False) # type: ignore # Read Netcdf-type WRF output file
...
if(save_data):
    print('##### saving data #####')
    np.savez( os.path.join('/anvil/scratch/x-smata/wrf_les_sweep/runs/gad_sweep/s0_v0/s0_v0.npz'),**var_holder)
    print('done.')