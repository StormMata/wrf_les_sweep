...
remove_data = 0 # in minutes;  discard first xxx minutes (e.g., ~2 flow-through times)
...
for case in casename:
    ...
    file2read = netCDF4.Dataset(f'/anvil/scratch/x-smata/wrf_les_sweep/runs/clockwise/gad_sweep/{case}/wrfout_d02_0001-01-01_00_00_00','r',mmap=False) # type: ignore # Read Netcdf-type WRF output file
