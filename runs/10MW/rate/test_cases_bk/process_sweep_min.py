...
for count,case in enumerate(casenames):
    ...
    file2read = netCDF4.Dataset(f'/scratch/09909/smata/wrf_les_sweep/runs/10MW/rate/test_cases/{case}/wrfout_d02_0001-01-01_00_00_00','r',mmap=False) # type: ignore # Read Netcdf-type WRF output file
    ...
    np.savez( os.path.join(f'/scratch/09909/smata/wrf_les_sweep/runs/10MW/rate/test_cases/{case}_lite.npz'),**var_holder)
