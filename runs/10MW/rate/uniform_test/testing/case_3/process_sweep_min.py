...
file2read = netCDF4.Dataset(f'/scratch/09909/smata/wrf_les_sweep/runs/10MW/rate/uniform_test/testing/case_3/s000_v000/wrfout_d02_0001-01-01_00_00_00','r',mmap=False) # type: ignore # Read Netcdf-type WRF output file
...
np.savez( os.path.join(f'/scratch/09909/smata/wrf_les_sweep/runs/10MW/rate/uniform_test/testing/case_3/s000_v000/U07_lite.npz'),**var_holder)
