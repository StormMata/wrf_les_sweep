...
file2read = netCDF4.Dataset(f'/home1/09909/smata/dir_scratch/wrf_les_sweep/runs/10MW/rate/uniform_test/new_testing/up_40/case_4/wrfout_d02_0001-01-01_00_00_00','r',mmap=False) # type: ignore # Read Netcdf-type WRF output file
...
np.savez( os.path.join(f'/home1/09909/smata/dir_scratch/wrf_les_sweep/runs/10MW/rate/uniform_test/new_testing/up_40/case_4/U07_lite.npz'),**var_holder)
